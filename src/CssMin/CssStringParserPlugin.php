...
/**
 * {@link CssParserPlugin Parser plugin} for preserve parsing string values.
 *
 * This plugin return no {@link CssToken CssToken} but ensures that string values will get parsed properly.
 *
 ...
 * @version        3.0.1
 */
class CssStringParserPlugin extends CssParserPlugin
{
    /**
