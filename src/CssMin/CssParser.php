...
class CssParser
{
     ...
     * Constructer.
     *
     *  Create instances of the used {@link CssParserPlugin plugins}.
     *
     ...
     *
     * @param CssToken $token Token to append
     * @return void
     */
    public function appendToken(CssToken $token)
    {
        $this->tokens[] = $token;
    }
