...
/**
 * This {@link CssMinifierPlugin} will process var-statement and sets the declaration value to the variable value.
 *
 ...
 * @version        3.0.1
 */
class CssVariablesMinifierPlugin extends CssMinifierPlugin
{
    /**
