...
/**
 * This {@link CssMinifierPlugin} will convert a color value in hsl notation to hexadecimal notation.
 *
 * Example:
 * <code>
 * color: hsl(232,36%,48%);
 ...
 * @version        3.0.1
 */
class CssConvertHslColorsMinifierPlugin extends CssMinifierPlugin
{
    /**
