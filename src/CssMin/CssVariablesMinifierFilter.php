...
/**
 * This {@link CssMinifierFilter minifier filter} will parse the variable declarations out of @variables at-rule
 ...
 * @version        3.0.1
 */
class CssVariablesMinifierFilter extends CssMinifierFilter
{
    /**
