...
/**
 * This {@link CssMinifierPlugin} will convert a color value in rgb notation to hexadecimal notation.
 *
 * Example:
 * <code>
 * color: rgb(200,60%,5);
 ...
 * @version        3.0.1
 */
class CssConvertRgbColorsMinifierPlugin extends CssMinifierPlugin
{
    /**
