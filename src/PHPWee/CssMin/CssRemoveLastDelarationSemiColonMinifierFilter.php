...
/**
 * This {@link CssMinifierFilter minifier filter} sets the IsLast property of any last declaration in a ruleset,
 ...
 * @version        3.0.1
 */
class CssRemoveLastDelarationSemiColonMinifierFilter extends CssMinifierFilter
{
    /**
