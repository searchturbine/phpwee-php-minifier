...
/**
 * This {@link CssMinifierPlugin} will convert hexadecimal color value with 6 chars to their 3 char hexadecimal
 ...
 * @version        3.0.1
 */
class CssCompressColorValuesMinifierPlugin extends CssMinifierPlugin
{
    /**
